...
import {
  FiCode, FiZap, FiTrendingUp, FiAward, FiUsers,
  FiArrowRight, FiCheck, FiBookOpen, FiShield,
} from "react-icons/fi";
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-100">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            {["Problems", "Challenges", "Learn", "Leaderboard"].map((item) => (
              <Link
                key={item}
                ...
                <div key={p.title} className="flex items-center justify-between bg-white border-2 border-slate-100 rounded-sm px-5 py-4 hover:border-slate-300 transition-all">
                  <div className="flex items-center gap-3 min-w-0">
                    <div className={`w-2 h-2 rounded-full shrink-0 ${
                      ...
                      p.status === "ATTEMPTED" ? "bg-amber-500" : "bg-slate-200"
                    }`} />
